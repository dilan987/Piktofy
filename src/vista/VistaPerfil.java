...
//           
    ...
    public void datosGlobales(){
        ...
        listausuario = ibj.consultarUsuarios("correoluisa@hotmail.com");// aqui deberia ir el correo global
        
        labelcorreo.setText(listausuario.get(i).getCorreoU());
        labelNombre.setText(listausuario.get(i).getNombre1U());
        labelNombre2.setText(listausuario.get(i).getNombre2U());
        apellido1.setText(listausuario.get(i).getApellido1U());
        apellido2.setText(listausuario.get(i).getApellido2U());
        contraseña.setText(listausuario.get(i).getContraseñaU());
        
        BufferedImage img = ImageIO.read(new ByteArrayInputStream(listausuario.get(i).getFotousuario()));
